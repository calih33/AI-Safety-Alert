...
#[Description("Add a ticket item to the database. It takes user_id, location_id, department_id, title, content, status (finished | not finished), priority (low, medium, high), and ai_summary as parameters.")]
    ...
    public function schema(JsonSchema $schema): array {
        return [
            ...
            'priority' => $schema->string()
                ...
                ->required(),
            'ai_summary' => $schema->string()
                ->description("A summary of the ticket generated by AI")
                ->required(),
        ];
    }
}
